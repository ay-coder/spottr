    ...
    <div class="row">
        ...
        <li>
        	<h3>2. Use License</h3>
        		<ul>
        		<li>
			        		a.	Permission is granted to temporarily download one copy of the Spottr social media application for personal, non-commercial transitory viewing only. This is the grant of a license, not a transfer of title, and under this license you may not:
			    <ul>
			    	<li>
					...
					<li>
						iii.	attempt to decompile or reverse engineer any software contained on Spottr LLC's web site;
					</li>
					<li>
